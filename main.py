...
# get the followers popup window:
WebDriverWait(driver, 10). \
    until(condition.presence_of_element_located((By.XPATH,
...
# load the list of [visible] accounts that follow the opened page
WebDriverWait(driver, 10). \
    until(condition.presence_of_element_located((By.XPATH,
...
while True:
    for itr in range(7):
        ...
        if follow_button.text == "Follow":
            follow_button.click()
        position += 1
    # will have to keep scrolling the popup window to load more accounts and add them to the list,
    # otherwise they do not exist in the DOM
